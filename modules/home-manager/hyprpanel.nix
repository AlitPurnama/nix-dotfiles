    ...
    programs.hyprpanel = {
      ...
      settings = {
        ...
        bar.volume.scrollDown =
          "/nix/store/0xdpska885bi168lfkxva95v47lsnayp-hyprpanel/bin/hyprpanel 'vol -5'";
        bar.volume.scrollUp =
          "/nix/store/0xdpska885bi168lfkxva95v47lsnayp-hyprpanel/bin/hyprpanel 'vol +5'";
        ...
        menus.dashboard.powermenu.avatar.name = "alit";
        ...
        menus.dashboard.shortcuts.right.shortcut3.command =
          ''bash -c "/nix/store/l3s52iggy014p38vi1ri5mi4rjb4qggb-snapshot.sh"'';
